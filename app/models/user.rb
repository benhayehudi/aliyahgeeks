class User < ApplicationRecord
  ...
  has_attached_file :image, :storage => :cloudinary, styles: { icon: "32x32", small: "64x64", med: "100x100", large: "200x200" }, :path =>"app/assets/images/headshots/:filename", :url => "/assets/headshots/:filename", :default_url => "/assets/headshots/default-author-headshot.png"

          ...
          <MetaTags>
            ...
            <div id="post-actions">
              <button id="button-heart" data-type="hearts" onClick={() => this.addHeartCount()}>
                <img src="/assets/icons/heart-icon.jpeg" id="reaction-img" />
              ...
              <button id="button-star" data-type="stars" onClick={() => this.addStarCount()}>
                <img src="/assets/icons/star-icon.png" id="reaction-img" />
              ...
              <button id="button-hands" data-type="hands" onClick={() => this.addHandCount()}>
                <img src="/assets/icons/hands-icon.png" id="reaction-img" />
              ...
              <button id="button-bookmark" onClick={() => this.addUserBookmark()}>
                <img src="/assets/icons/bookmark-icon-small.png" id="reaction-img" />
              </button> 
            </div>
